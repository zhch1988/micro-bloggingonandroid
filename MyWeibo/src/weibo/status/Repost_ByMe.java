...
import weibo.constant.*;

/**
 * @author 王景
 */

public class Repost_ByMe {
	List<Status> status;
	String result;
	 ...
	 * @param 参数为用户的ID
	 */
	public Repost_ByMe(String id) {
		String url = "http://api.t.sina.com.cn/statuses/repost_by_me.json";
	...
	public List<Status> getRepost_ByMe() {
		try {
