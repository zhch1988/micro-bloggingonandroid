...
public class Comment_Counts {
	 ...
	 *            ，中间用,隔开
	 */
	public Comment_Counts(String ids) {
		...
		demo.add(new BasicNameValuePair("id", ids));
	...
	public List<Counts> getComment_Counts() {
