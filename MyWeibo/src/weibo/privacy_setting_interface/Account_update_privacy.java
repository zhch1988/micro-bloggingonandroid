...
public class Account_update_privacy {
	 ...
	 * 
	 * @param comment
	 *            :谁可以评论此账号的微博。0：所有人，1：我关注的人。默认为0。
	 * @param message
	 *            ：谁可以给此账号发私信。0：所有人，1：我关注的人。默认为1。
	 * @param realname
	 *            ：是否允许别人通过真实姓名搜索到我， 0允许，1不允许，默认值1。
	 * @param geo
	 *            ：发布微博，是否允许微博保存并显示所处的地理位置信息。 0允许，1不允许，默认值0。
	 * @param badge
	 *            ：勋章展现状态。1私密状态，0公开状态，默认值0。
	 */
