...
//
// ]
public class Tags_create {
	public Tags_create(String tags) {
		// json请求格式
		// JSON
		// curl -u "username:password" -d "tags=CSDN,BLOGJAVA"
		// "http://api.t.sina.com.cn/tags/create.json?source=appkey"
		// api地址
		String url = "http://api.t.sina.com.cn/tags/create.json";
		// 新建一个POST
